      ...
      <li className="wd-module">
        ...
        <ul className="wd-lessons">
          <li className="wd-lesson">
            <span className="wd-title">LEARNING OBJECTIVES</span>
            <ul className="wd-content">
              <li className="wd-content-item">Learn how to create tables</li>
              <li className="wd-content-item">Learn how to create forms</li>
            </ul>
          </li>
          <li className="wd-lesson">
            <span className="wd-title">READING</span>
          ...
          <li className="wd-lesson">
            <span className="wd-title">SLIDES</span>
            <ul className="wd-content">
              <li className="wd-content-item">Creating Tables in HTML</li>
              <li className="wd-content-item">Creating Forms in HTML</li>
            </ul>
          </li>
        </ul>
      </li>
